...
<script type="text/javascript"
	src="<%=baseurl%>/js/html/login/login.js"></script>
...
<body style="background: #f6f6f6">
	...
	<div class="wrapper" id="login_head" style="display:">
		<div class="log_head">
			<h1 class="log_logo left">
				<a href="#"><span>后台管理系统</span></a>
			</h1>
		</div>
	</div>
	<div class="login_wrap"
		style="width:; background: #fff url(<%=baseurl%>/images/20161209115754_5628.jpg) no-repeat center top; padding: 40px 0;">
		<div class="wrapper" id="login_body" style="width:;">
			<div class="log_ad" style="display:">
				<a href="javascript:;"></a>
			</div>
				...
				<div class="login" style="display: block;">
					...
					<div class="login-body">
							...
							<dl>
								<dd>
									<input type="password" id="Userpwd"
										onKeyDown="enterHandler(event)" placeholder="请输入您的密码" />
								</dd>
							</dl>

							<div class="remember">
								<input type="checkbox" id="issave" checked /><label
									for="issave">下次自动登录</label>
							</div>
							<div class="tishi"></div>
							<button onClick="cliLogin()" id="logbtn" style="outline: none">登
								录</button>
						</div>
						<div class="login-style">
							<dl>
								<dd>
									<input name="phone" type="text" id="phone" placeholder="您的手机号码" />
								</dd>
							</dl>
						...
						<dd><input type="text" id="txtCode2" name="txtCode2" style="width: 133px; margin-right: 10px;" placeholder="验证码" /><img id="Img1" src="" width="90" height="34" title="点击换一个" style="vertical-align: middle; margin-top: -4px;" onclick="this.src='/ImgCode.aspx?t='+Math.random()*100" /></dd>
							...
							<dl>
								<dd>
									<input type="text" id="dynamicPWD"
										onKeyDown="enterHandler(event)" style="width: 133px;"
										placeholder="短信验证码" /><input type="button" id="btn"
										class="btn_mfyzm" value="获取动态密码" onClick="Sendpwd(this)" />
								</dd>
							</dl>
							<div class="remember">
								<input type="checkbox" id="issave1" checked /><label
									for="issave1">下次自动登录</label>
							</div>
							<div class="tishi"></div>
							<button type="button" id="dynamicLogon" style="outline: none">登
								录</button>
						</div>
					</div>
	...
	<div class="bottom">
		<div class="wrapper">
			<div class="copy">
				<p>全国服务热线：0431-848633 &nbsp;&nbsp;&nbsp;&nbsp; 工作时间：周一至周日
					09:00-20:30</p>
				<p>
					网站ICP备案号：<a rel="nofollow" href="javascript:;" target="_blank">吉ICP备xxxxx号</a>
					&nbsp;&nbsp;&nbsp;&nbsp; 电信业务经营许可证：吉A-xxxx号
					&nbsp;&nbsp;&nbsp;&nbsp;
				</p>
