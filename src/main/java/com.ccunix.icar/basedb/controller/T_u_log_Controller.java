...
import com.ccunix.icar.basedb.service.T_u_log_Service_Iface;
@Controller
@RequestMapping("T_u_log_Controller")
public class T_u_log_Controller extends BaseMultiController {
@Resource
public T_u_log_Service_Iface t_u_log_service_iface;
