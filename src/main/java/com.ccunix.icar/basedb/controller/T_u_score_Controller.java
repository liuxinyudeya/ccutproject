...
import com.ccunix.icar.basedb.service.T_u_score_Service_Iface;
@Controller
@RequestMapping("T_u_score_Controller")
public class T_u_score_Controller extends BaseMultiController {
@Resource
public T_u_score_Service_Iface t_u_score_service_iface;
