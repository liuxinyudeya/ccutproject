...
import com.ccunix.icar.basedb.dao.T_u_franchisee_Dao_Iface;

@Service("T_u_franchisee_Service")
@Transactional(propagation = Propagation.REQUIRED, rollbackFor = Exception.class)
public class T_u_franchisee_Service_Impl extends BaseService implements T_u_franchisee_Service_Iface {
@Resource
public T_u_franchisee_Dao_Iface t_u_franchisee_dao_iface;
public void insert_t_u_franchisee(T_u_franchisee t_u_franchisee) throws Exception{
t_u_franchisee_dao_iface.insert_t_u_franchisee(t_u_franchisee);
}
public void update_t_u_franchisee(T_u_franchisee t_u_franchisee) throws Exception{
t_u_franchisee_dao_iface.update_t_u_franchisee(t_u_franchisee);
}
public void delete_t_u_franchisee(T_u_franchisee t_u_franchisee) throws Exception{
t_u_franchisee_dao_iface.delete_t_u_franchisee(t_u_franchisee);
}
public List queryAll_t_u_franchisee(T_u_franchisee t_u_franchisee) throws Exception{
return t_u_franchisee_dao_iface.queryAll_t_u_franchisee(t_u_franchisee);
}
public List queryBy_t_u_franchisee(T_u_franchisee t_u_franchisee) throws Exception{
return t_u_franchisee_dao_iface.queryBy_t_u_franchisee(t_u_franchisee);
}
}