...
import com.ccunix.icar.basedb.dao.T_s_system_config_Dao_Iface;

@Service("T_s_system_config_Service")
@Transactional(propagation = Propagation.REQUIRED, rollbackFor = Exception.class)
public class T_s_system_config_Service_Impl extends BaseService implements T_s_system_config_Service_Iface {
@Resource
public T_s_system_config_Dao_Iface t_s_system_config_dao_iface;
public void insert_t_s_system_config(T_s_system_config t_s_system_config) throws Exception{
t_s_system_config_dao_iface.insert_t_s_system_config(t_s_system_config);
}
public void update_t_s_system_config(T_s_system_config t_s_system_config) throws Exception{
t_s_system_config_dao_iface.update_t_s_system_config(t_s_system_config);
}
public void delete_t_s_system_config(T_s_system_config t_s_system_config) throws Exception{
t_s_system_config_dao_iface.delete_t_s_system_config(t_s_system_config);
}
public List queryAll_t_s_system_config(T_s_system_config t_s_system_config) throws Exception{
return t_s_system_config_dao_iface.queryAll_t_s_system_config(t_s_system_config);
}
public List queryBy_t_s_system_config(T_s_system_config t_s_system_config) throws Exception{
return t_s_system_config_dao_iface.queryBy_t_s_system_config(t_s_system_config);
}
}